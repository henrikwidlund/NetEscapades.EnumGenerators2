...
public class EnumWithSameDisplayNameExtensionsTests : ExtensionTests<EnumWithSameDisplayName>
{
    ...
    protected override bool IsDefined(string name, bool allowMatchingMetadataAttribute = false)
        => EnumWithSameDisplayNameExtensions.IsDefined(name, allowMatchingMetadataAttribute);
    ...
    protected override EnumWithSameDisplayName? GetValueOrDefault(string name, bool ignoreCase, bool allowMatchingMetadataAttribute)
        => EnumWithSameDisplayNameExtensions.GetValueOrDefault(name, ignoreCase, allowMatchingMetadataAttribute);

    protected override EnumWithSameDisplayName? GetValueOrDefault(in ReadOnlySpan<char> name, bool ignoreCase, bool allowMatchingMetadataAttribute)
        => EnumWithSameDisplayNameExtensions.GetValueOrDefault(name, ignoreCase, allowMatchingMetadataAttribute);
    ...
    [Theory]
    [MemberData(nameof(ValuesToParse))]
    public void GeneratesIsDefinedUsingNameAsSpan(string name)
        => GeneratesIsDefinedTest(name.AsSpan(), false);
    ...
    public void GeneratesGetMetadataNamesOrDefault()
        => GeneratesGetMetadataNamesOrDefaultTest(EnumWithSameDisplayNameExtensions.GetMetadataNamesOrDefault());

    [Fact]
    public void GeneratesGetValues() => GeneratesGetValuesTest(EnumWithSameDisplayNameExtensions.GetValues());

    [Fact]
    public void GeneratesGetNames() => GeneratesGetNamesTest(EnumWithSameDisplayNameExtensions.GetNames());
}
